 ...
 * the resizer takes a centre square (scaleMode 'cover' into 192x192), while the
 * preview covers a view of a different aspect ratio. Skipping either step puts
 * the skeleton visibly off the body.
 */
function toView(
  k: Keypoint,
  frameW: number,
