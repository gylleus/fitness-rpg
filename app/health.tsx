...
export default function HealthScreen() {
  ...
  return <Screen>
    ...
    <Card>
      ...
      <Text style={ui.body}>Connect once. Your daily steps then refresh automatically when you open the app and while you play.</Text>
